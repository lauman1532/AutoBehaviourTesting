...
RFIDuino::RFIDuino()
{
  ...
  // Vick Lau: removed all pinMode(), digitalWrite() from constructor as the constructor
  // is usually called before the setup(), breaking the functions.
}

void RFIDuino::init(void)
{
